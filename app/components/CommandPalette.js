...
export default function CommandPalette({ open, onClose, drives = [], isAdmin = false, onShortcuts }) {
  ...
  const actions = useMemo(() => [
    ...
    isAdmin && { id: 'storage', label: 'Storage usage', hint: 'What is using the space', run: () => go('/storage') },
    isAdmin && { id: 'duplicates', label: 'Find duplicate files', hint: 'Storage', run: () => go('/storage/duplicates') },
