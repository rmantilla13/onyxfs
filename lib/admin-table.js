...
/**
 * Below this many px of its own width a DataTable is drawn as cards. The
 * container query in app/admin/admin.css says the same number; keep them
 * together.
 */
export const CARD_BELOW = 800;
