...
export const BRAND = {
  ...
  visual: {
    ...
    logo: {
      ...
      // The ONYX/FS wordmark, and the same with light letters for the dark
      // scheme — dark letters drawn for paper vanish on near-black.
      lockupPath: '/onyx-lockup.svg',
      lockupDarkPath: '/onyx-lockup-dark.svg',
    },
    radius: '8px',
  },
