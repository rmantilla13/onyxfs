...
export async function createFile(data = {}) {
  ...
  const rows = await sql`
    INSERT INTO files (id, name, folder, kind, mime, size, url, storage, storage_key, tags, notes, visibility, thumbnail_url, thumbnail_key, filmstrip_key, metadata, created_by, created_at, updated_at, seq)
    VALUES (
