...
/** What an upload may be before it is re-encoded. Larger is refused unread. */
...
export function avatarFileProblem(file) {
  ...
  if (file.size > AVATAR_MAX_BYTES) return 'That picture is over 8 MB. Choose a smaller one.';
