...
export const BUILTIN_ROLES = [
  ...
  },
  {
    ...
    name: 'Viewer',
    description:
      'Read-only. Browse and download what they are granted, with no sharing, no metadata editing, and no trash.',
    features: grantOnly(['notifications', 'thumbnails', 'usageRights']),
    builtin: true,
  },
];
