 ...
 * mentioned SUPER_ADMIN_EMAILS or SLACK_WEBHOOK_URL.
 *
...
export const ENV_VARS = [
  ...
  },
  {
    key: 'ADMIN_EMAILS',
    requirement: 'recommended',
    why: 'Comma-separated admins — the only way to be one; no role grants it. Unset, the only admin is the bootstrap address compiled into lib/auth-allowlist.js.',
  },
  {
    key: 'SUPER_ADMIN_EMAILS',
    requirement: 'optional',
    why: 'Stricter subset of admins, for the storage backend and the AI key and budget. Unset, every admin is one.',
  },
  {
...
export const ENV_VARS_RETIRED = [
  ...
  { key: 'NEXT_PUBLIC_ALLOWED_EMAILS', why: 'Same dead client path, for a list that is itself gone: sign-in is by invitation only.' },
  { key: 'NEXT_PUBLIC_ALLOWED_EMAIL_DOMAIN', why: 'Same dead client path, for a list that is itself gone: sign-in is by invitation only.' },
  {
    key: 'ALLOWED_EMAIL_DOMAIN',
    why: 'Documented for a while and read by nothing: sign-in is by invitation only. Approve people in Admin → Access instead.',
  },
  {
    key: 'ALLOWED_EMAILS',
    why: 'Documented for a while and read by nothing: sign-in is by invitation only. Add people in Admin → Access, or to ADMIN_EMAILS.',
  },
];
