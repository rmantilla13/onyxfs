...
export const INTEGRATIONS = [
  {
    ...
    setupSteps: [
      'In Vercel → Storage, create or connect a Neon Postgres database.',
      'DATABASE_URL is injected automatically. No migration step — tables are created lazily on first use.',
    ],
  },
  {
    key: 'auth',
